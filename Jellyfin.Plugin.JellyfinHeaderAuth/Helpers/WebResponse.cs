// The contents of this file are "HEAVILY inspired" by "9p4/jellyfin-plugin-sso" which is licensed under GPLv3.
// Original file: https://github.com/9p4/jellyfin-plugin-sso/blob/6cb5fc33bfe9be6a8c3a781422d4bed7429f2c9c/SSO-Auth/WebResponse.cs

namespace Jellyfin.Plugin.JellyfinHeaderAuth.Helpers
{
    /// <summary>
    ...
    ";
        ...
        public static string Generator(string baseUrl)
        {
            return Base + @"
            async function main() {
                ...
                var request = {deviceId, appName, appVersion, deviceName};
